...
public class GetVolunteerRequestByAdminWithPaginationQueryValidator
    : AbstractValidator<GetVolunteerRequestByAdminWithPaginationQuery>
{
    public GetVolunteerRequestByAdminWithPaginationQueryValidator()
    {
        RuleFor(q => q.Status)
